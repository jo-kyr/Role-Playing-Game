...
#### Adjustments
Since the objects I imported had rigid body and collider components, I decided to add them to the walls and Neko as well. I kept testing the game and adjusting the physics, the order of the layers and the controller script accordingly.
...
Lastly, I added a camera that follows the player throught the level, and some background music.

![camera](https://user-images.githubusercontent.com/97399069/201434406-660cf47c-09d4-4eae-bf28-aacb88e3081d.png)
![music](https://user-images.githubusercontent.com/97399069/201434415-851ea0a7-866a-4f8e-9ea7-f3fc7a5a04ba.png)
